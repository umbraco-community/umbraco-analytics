angular.module("umbraco").directive('dateRangePicker', function (assetsService) {
    return {
        restrict: 'A',
        require: 'ngModel',
        scope: {
        ...
        link: function (scope, element) {
            $(function () {
                assetsService.loadJs("/App_Plugins/Analytics/lib/momentjs/moment.js", scope, { charset: 'utf-8' }, 10000).then(function () {
